...
Billing-Fraud-Detection-System-using-Machine-Learning/
│
├── analysis\_model.ipynb        # EDA, feature engineering, model training \& comparison
├── train\_model.py              # Script to train and save the production model
├── app.py                      # Streamlit web app for live predictions
├── models/                     # Saved/serialized trained model(s)
├── billing\_fraud\_dataset.csv   # Sample billing dataset used for training
├── billing\_fraud\_report.md     # Detailed project report
├── implementation\_plan.md      # Project planning and implementation notes
├── walkthrough.md              # Step-by-step walkthrough of the pipeline
├── requirements.txt            # Python dependencies
└── README.md
```
📊 Dataset
The dataset used (`billing\_fraud\_dataset.csv`) contains sample utility billing records with features engineered to capture patterns associated with fraudulent billing behavior. See `billing\_fraud\_report.md` for a full breakdown of the fields and preprocessing steps.
...
Full details and code are in `analysis\_model.ipynb`.
...
```
jupyter notebook analysis\_model.ipynb
```
📄 Additional Documentation
`billing\_fraud\_report.md` — Detailed project report
`implementation\_plan.md` — Planning and implementation notes
